...
if not df.empty:
    graficar_metricas(df, x="archivo", y="V", titulo="Volumen Halstead por archivo")
    graficar_metricas(df, x="archivo", y="E", titulo="Esfuerzo Halstead por archivo")
    graficar_metricas(df, x="archivo", y="McCabe", titulo="Complejidad McCabe por archivo")
