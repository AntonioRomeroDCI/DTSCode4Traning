...
CARPETA_CLASES="./Code/ChatGPT/v2/Refactored"

# Archivo de promedios general
promedios_csv="./Data/Times/ChatGPT/v2/Refactored/promedios.csv"
...
do
    ...
    resultados_csv="./Data/Times/ChatGPT/v2/Refactored/resultados_${CLASE}.csv"
    ...
    for i in {1..100}
    do
        output_and_metrics=$( { /usr/bin/time -f "%e,%M" java Code.ChatGPT.v2.Refactored."$CLASE"; } 2>&1 )
